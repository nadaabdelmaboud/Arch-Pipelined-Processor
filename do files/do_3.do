...
mem load -i {D:\CMP 3rd Year\Second Sem\Arch Project\Arch-Pipelined-Processor\memoryFiles\memory3.mem} -format hex /pipeline/Fetch_Stage/ram_component/ram
mem load -i {D:\CMP 3rd Year\Second Sem\Arch Project\Arch-Pipelined-Processor\memoryFiles\memory3.mem} -format hex /pipeline/Memory_Stage/ram_component/ram
